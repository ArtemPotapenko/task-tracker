...
import (
	...
	"os/signal"
	"syscall"
	"task-tracker/email-service/internal/cache"
	kafka2 "task-tracker/email-service/internal/transport/kafka"
	...
	"task-tracker/email-service/internal/config"
	"task-tracker/email-service/internal/mailer"
	transportgrpc "task-tracker/email-service/internal/transport/grpc"
	"task-tracker/email-service/internal/usecase"
	accountpb "task-tracker/proto-lib/gen/private/account"
	pkgcache "task-tracker/shared-libs/pkg/cache"
